...
use crate::stdvm::errors::std_error::{
    CheckedFromRatioError, CheckedMultiplyRatioError, DivideByZeroError, OverflowError,
    OverflowOperation, RoundUpOverflowError, StdError,
};
use crate::stdvm::math::{Decimal, Uint512};
...
impl Decimal256 {
    ...
    pub fn checked_mul(self, other: Self) -> Result<Self, OverflowError> {
        ...
        //         operation: crate::stdvm::errors::std_error::OverflowOperation::Mul,
        //         operand1: self.to_string(),
        //         operand2: other.to_string(),
        //     })

        panic!("checked_mul error")
    }
    ...
    pub fn checked_pow(self, exp: u32) -> Result<Self, OverflowError> {
        ...
        inner(self, exp).map_err(|_| OverflowError {
            operation: crate::stdvm::errors::std_error::OverflowOperation::Pow,
            operand1: self.to_string(),
...
mod tests {
    use super::*;
    use crate::stdvm::errors::std_error::StdError;
